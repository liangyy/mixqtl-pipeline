...
ggsave('../output/grid_sim-multi_0613_prediction_pearson.pdf', p, height = 5.5, width = 3.5)
```
...
ggsave('../output/grid_sim-multi_0613_prediction_pearson_pair.pdf', p, height = 5.5, width = 3.5)
```
