...
ggsave('../output/gtex-v8-pipeline-eqtl-matrix-with-gene-qc-eqtlgen-positive.pdf', p, height = 4, width = 4)
collector = df
...
ggsave(paste0('../output/gtex-v8-pipeline-eqtl-matrix-with-gene-qc-eqtlgen-positive-chisq.pdf'), p, height = 4, width = 4)
```
...
ggsave('../output/gtex-v8-pipeline-eqtl-matrix-with-gene-qc-eqtlgen-negative.pdf', p, height = 4, width = 4)
for(m in c('ascQTL', 'trcQTL', 'mixQTL')) {
  sub = df %>% filter(method %in% c(m, 'eQTL'))
  p = my_qqplot(sub$pval, sub$method) 
  p$layers <- c(geom_abline(slope = 1, intercept = 0, color = 'lightgray'), p$layers)
...
ggsave('../output/gtex-v8-pipeline-eqtl-matrix-with-gene-qc-eqtlgen-roc-stratified.pdf', p, width = 10, height = 4)
ggsave('../output/gtex-v8-pipeline-eqtl-matrix-with-gene-qc-eqtlgen-pr-stratified.png', p2, width = 10, height = 4)
ggsave('../output/gtex-v8-pipeline-eqtl-matrix-with-gene-qc-eqtlgen-pr-stratified.pdf', p2, width = 10, height = 4)
```