...
awk 'FNR==NR{a[$1]=1;next}{ if(FNR in a) print $0}' $prefix.idx.subsample$1-with-gene-qc.txt <(zcat $prefix.pos-with-gene-qc.txt.gz) | gzip > $prefix.subsample$1-with-gene-qc.txt.gz
