...
mix_estimate = mixqtl(geno1, geno2, df$y_ase1, df$y_ase2, df$y_trc, df$lib_size, cov_offset = indiv_offset, trc_cutoff = 15, asc_cutoff = 5, weight_cap = 10, asc_cap = 1000)
